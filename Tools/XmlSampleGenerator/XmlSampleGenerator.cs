...
namespace Microsoft.Xml.XMLGen
{
    ...
    {
        private XmlQualifiedName head;
        private readonly ArrayList members = new ArrayList();
    ...
    public class XmlSampleGenerator
    {
            ...
            if (!eGlobalDecl.IsAbstract)
            {
                ...
                else
                {
                    ...
                    { //elementType is XmlSchemaSimpleType
                        elem.ValueGenerator = XmlValueGenerator.TryCreateGenerator(eGlobalDecl.ElementSchemaType.Datatype, listLength);
                    }
                }
        ...
        private void ProcessComplexType(XmlSchemaComplexType ct, InstanceElement elem)
        {
            ...
            {
                elem.ValueGenerator = XmlValueGenerator.TryCreateGenerator(ct.Datatype, listLength);
            }
            else
            {
        ...
        private void GenerateInstanceAttribute(XmlSchemaAttribute attr, InstanceElement elem)
        {
            ...
            InstanceAttribute iAttr = new InstanceAttribute(attr.QualifiedName)
            {
                ...
                AttrUse = attr.Use,
                ValueGenerator = XmlValueGenerator.TryCreateGenerator(attr.AttributeSchemaType.Datatype, listLength)
            };
